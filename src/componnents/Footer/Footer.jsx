    ...
    return (
        <div className='footer'>
            <div>
                ...
                <p>props: received array data to a component to another component by using a loop like map(rad-only, !modified)
state: contain data or information(async, modified using this.setState)</p>
            </div>
            <div>
                <h2>How does useState work?</h2>
                <p>useState a hook of React that can allow adding state to a functional component
...
which is a lightweight representation of the actual DOM.
